...
export class CanvasRecorder {
    ...
    async start() {
        try {
            // Capture canvas stream without FPS limit
            // This ensures we capture EVERY frame we render, no skipping
            // FPS is controlled by the rendering loop, not by captureStream
            ...
            console.log('✓ Canvas recording started (manual FPS control)');

...
export class CanvasRecorder {
    ...
    /**
     * Start recording
     * Uses captureStream(fps) - browser handles frame sampling at target FPS
     */
    async start() {
        try {
            // Capture stream at target framerate
            // Browser will sample frames from canvas at this rate
            ...
            console.log(`✓ Canvas recording started at ${this.options.frameRate}fps`);
